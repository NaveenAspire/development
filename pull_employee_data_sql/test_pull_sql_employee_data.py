...
from pull_sql_employee_data import PullSqlEmployeeData, get_bool,parent_dir
...
class Test_pull_sql_employee_data:
    ...
    # def test_get_partition_done(self,join_date, s_date, e_date,):  # --tested
    #     """This method will test whether it get paartition is sucessful"""
    #     self.obj = PullSqlEmployeeData(s_date, e_date)
    #     try:
    #         date_obj = datetime.strptime(join_date, "%Y-%m-%dT%H")
    #         partition_path = date_obj.strftime("pt_year=%Y/pt_month=%m/pt_day=%d/")
    #     except Exception as err:
    ...
    # # def test_get_bool_not_done(self):
